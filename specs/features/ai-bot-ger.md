...
- **Crear Clientes**: "Ger, crea un cliente con nombre Pedro Corbalán" -> El bot recopila datos, muestra resumen y pide confirmación antes de crear.
- **Crear Productos**: "Ger, crea producto Barra LED 20 pulgadas" -> El bot recopila categoría, costos y stock, muestra resumen y pide confirmación.
