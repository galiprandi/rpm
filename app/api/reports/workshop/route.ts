...
import { getWorkshopReport, type WorkshopGroupBy } from "@/lib/services/workshopReportService";
...
export async function GET(request: Request) {
  try {
    ...
    const groupByParam = searchParams.get("groupBy") as WorkshopGroupBy | null;
    ...
    console.error("Error in reports/workshop API:", error);
    return NextResponse.json(
