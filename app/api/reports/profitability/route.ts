...
import { getProfitabilityReport, type ProfitabilityGroupBy } from "@/lib/services/profitabilityReportService";
...
export async function GET(request: Request) {
  try {
    ...
    const groupByParam = searchParams.get("groupBy") as ProfitabilityGroupBy | null;
    ...
    console.error("Error in reports/profitability API:", error);
    return NextResponse.json(
