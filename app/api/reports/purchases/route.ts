...
import { getPurchaseReport, type PurchaseGroupBy } from "@/lib/services/purchaseReportService";
...
export async function GET(request: Request) {
  try {
    ...
    const groupByParam = searchParams.get("groupBy") as PurchaseGroupBy | null;
    ...
    console.error("Error in reports/purchases API:", error);
    return NextResponse.json(
