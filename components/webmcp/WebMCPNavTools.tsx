...
const sections = [
  'dashboard', 'products', 'customers', 'suppliers', 'services',
  'categories', 'work-orders', 'vehicles', 'invoices', 'direct-sales',
  'price-lists', 'purchase-vouchers', 'credit-notes', 'cash',
  'operations', 'users', 'settings', 'reports',
] as const;
    ...
    mc.registerTool(
      {
        ...
        description: 'Navega a una sección del panel de administración. Úsala cuando el usuario pide ir a una página específica como productos, clientes, órdenes de trabajo, etc.',
        inputSchema: {
          type: 'object',
          properties: {
            section: {
