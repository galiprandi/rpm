...
## ✅ COMPLETADO
- [x] 2026-08-06 — Historial de Vehículo y Duplicación de Ítems en el Asistente de OT (PR #jorge/work-orders/wizard-vehicle-history)
...
## 2026-08-06 - Historial de Vehículo y Duplicación de Ítems en el Asistente de OT
**Aprendizaje 1:** Los mecánicos y recepcionistas necesitan ver de inmediato el contexto previo de reparaciones de un vehículo al iniciar un nuevo servicio, sin tener que navegar a múltiples pestañas secundarias o fichas. Implementar una vista de dos columnas en el Paso 1 de creación, con los detalles técnicos del vehículo cargado en la izquierda y su historial cronológico detallado en la derecha, ofrece un diseño sumamente profesional que elimina por completo el trabajo administrativo repetitivo.
**Aprendizaje 2:** Al clonar o duplicar servicios/productos cargados en órdenes anteriores, resguardar la experiencia del usuario mostrando una confirmación interactiva para evitar pisar accidentalmente borradores en curso protege los flujos de carga de datos complejos.
**Aprendizaje 3:** Al realizar pruebas de Testing Library en React con llamadas a APIs encadenadas asincrónicamente o efectos secuenciales, es vital esperar explícitamente a que los componentes y textos más internos y profundos del DOM se carguen y se rendericen usando expresiones regulares robustas para que las interacciones y clicks de prueba sean completamente deterministas y confiables en JSDOM.
...
**Acción:** Siempre acoplar los guardados automáticos de localStorage with banderas de carga (`isLoaded`) para evitar sobreescritura prematura del estado, y proveer atajos de clonación contextual para flujos de registro repetitivos.
